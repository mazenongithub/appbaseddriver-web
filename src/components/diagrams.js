...
class Diagrams {
    ...
    showdiagrams() {
        ...
        const januaryearnings = (shift) => {
            ...
            const showlabel = diagrams.showshiftlabel.call(this, shift)
            const label = (showlabel) => {
                if (showlabel) {
                    return (<g>
                        ...
                        <text className="largeexpanded-7" transform="translate(13.02 13.43)"><tspan>{abbMonth(shift.timein)}, ${Number(shift.earnings).toFixed(2)}, </tspan><tspan x="0" y="12">earnings</tspan></text></g>)
            ...
            return (
                <g transform={`translate(${day * 9.67},0)`} key={`svg${shift.shiftid}`} onClick={() => { diagrams.handleshiftid.call(this, shift) }}>
        ...
        const februaryearnings = (shift) => {
            ...
            return (
                <g transform={`translate(${day * 10.34},0)`} key={`svg${shift.shiftid}`} onClick={() => { diagrams.handleshiftid.call(this, shift) }}>
            ...
            const label = (showlabel) => {
                if (showlabel) {
                    return (<g>   <path className="largeexpanded-6" d="M692.47,4V29.88a1.9,1.9,0,0,1-1.9,1.91H623.1a2.25,2.25,0,0,0-.52.07l-12.36,3.47A1.91,1.91,0,0,1,607.86,33l3-10.72a1.86,1.86,0,0,0,.07-.52V4A1.92,1.92,0,0,1,612.85,2h77.72A1.91,1.91,0,0,1,692.47,4Z" />
                        <text className="largeexpanded-7" transform="translate(614.16 13.95)"><tspan>{abbMonth(shift.timein)}, ${Number(shift.earnings).toFixed(2)},</tspan><tspan x="0" y="12">earnings</tspan></text></g>)

                }
            }

            return (<g transform={`translate(${day * 9.67},0)`} key={`svg${shift.shiftid}`} onClick={() => { diagrams.handleshiftid.call(this, shift) }}>
        ...
        const aprilearnings = (shift) => {
            ...
            return (<g transform={`translate(${day * 10},0)`} key={`svg${shift.shiftid}`} onClick={() => { diagrams.handleshiftid.call(this, shift) }}>
            ...
            const label = (showlabel) => {
                if (showlabel) {
                    return (<g>  <path className="largeexpanded-6" d="M91.59,166.7v25.93a1.91,1.91,0,0,1-1.91,1.91H22.21a1.82,1.82,0,0,0-.52.08L9.33,198.09A1.91,1.91,0,0,1,7,195.73L10,185a1.82,1.82,0,0,0,.08-.52V166.7A1.91,1.91,0,0,1,12,164.79H89.68A1.92,1.92,0,0,1,91.59,166.7Z" />
                        <text className="largeexpanded-7" transform="translate(13.27 176.71)"> <tspan>{abbMonth(shift.timein)}, ${Number(shift.earnings).toFixed(2)}, </tspan><tspan x="0" y="12">earnings</tspan></text></g>)
            ...
            const label = (showlabel) => {
                if (showlabel) {
                    return (<g>  <path className="largeexpanded-6" d="M393.86,166.7v25.93a1.91,1.91,0,0,1-1.91,1.91H324.48a1.75,1.75,0,0,0-.51.08l-12.37,3.47a1.91,1.91,0,0,1-2.35-2.36l3-10.72a1.81,1.81,0,0,0,.07-.52V166.7a1.91,1.91,0,0,1,1.91-1.91H392A1.92,1.92,0,0,1,393.86,166.7Z" />
                        <text className="largeexpanded-7" transform="translate(315.54 176.71)"><tspan>{abbMonth(shift.timein)}, ${Number(shift.earnings).toFixed(2)}, </tspan><tspan x="0" y="12">earnings</tspan></text></g>)
            ...
            const label = (showlabel) => {
                if (showlabel) {
                    return (<g>  <path className="largeexpanded-6" d="M691.84,166.7v25.93a1.91,1.91,0,0,1-1.91,1.91H622.46a1.88,1.88,0,0,0-.52.08l-12.36,3.47a1.91,1.91,0,0,1-2.35-2.36l3-10.72a2.25,2.25,0,0,0,.07-.52V166.7a1.91,1.91,0,0,1,1.91-1.91h77.71A1.92,1.92,0,0,1,691.84,166.7Z" />
                        <text className="largeexpanded-7" transform="translate(613.52 176.71)"><tspan>{abbMonth(shift.timein)}, ${Number(shift.earnings).toFixed(2)}, </tspan><tspan x="0" y="12">earnings</tspan></text></g>)
            ...
            const label = (showlabel) => {
                if (showlabel) {
                    return (<g> <path className="largeexpanded-6" d="M992.49,166.7v25.93a1.9,1.9,0,0,1-1.91,1.91H923.11a1.81,1.81,0,0,0-.51.08l-12.36,3.47a1.91,1.91,0,0,1-2.36-2.36l3-10.72a1.81,1.81,0,0,0,.07-.52V166.7a1.92,1.92,0,0,1,1.91-1.91h77.71A1.91,1.91,0,0,1,992.49,166.7Z" />
                        <text className="largeexpanded-7" transform="translate(914.17 176.71)"><tspan>{abbMonth(shift.timein)}, ${Number(shift.earnings).toFixed(2)}, </tspan><tspan x="0" y="12">earnings</tspan></text></g>)
            ...
            const label = (showlabel) => {
                if (showlabel) {
                    return (<g>  <path className="largeexpanded-6" d="M91.83,332.48v25.93a1.9,1.9,0,0,1-1.91,1.91H22.45a2.24,2.24,0,0,0-.51.07L9.57,363.86a1.91,1.91,0,0,1-2.35-2.35l3-10.72a1.81,1.81,0,0,0,.07-.52V332.48a1.92,1.92,0,0,1,1.91-1.91H89.92A1.91,1.91,0,0,1,91.83,332.48Z" />
                        <text className="largeexpanded-7" transform="translate(13.02 343.76)"><tspan>{abbMonth(shift.timein)}, ${Number(shift.earnings).toFixed(2)}, </tspan><tspan x="0" y="12">earnings</tspan></text></g>)

                }
            }
            return (
                <g transform={`translate(${day * 10},0)`} key={`svg${shift.shiftid}`} onClick={() => { diagrams.handleshiftid.call(this, shift) }}>
            ...
            const label = (showlabel) => {
                if (showlabel) {
                    return (<g> <path className="largeexpanded-6" d="M392,331.33v25.93a1.91,1.91,0,0,1-1.91,1.91H322.67a1.81,1.81,0,0,0-.52.07l-12.36,3.47a1.91,1.91,0,0,1-2.36-2.36l3-10.72a1.79,1.79,0,0,0,.07-.51V331.33a1.91,1.91,0,0,1,1.91-1.91h77.71A1.9,1.9,0,0,1,392,331.33Z" />
                        <text className="largeexpanded-7" transform="translate(313.72 341.33)"><tspan>{abbMonth(shift.timein)}, ${Number(shift.earnings).toFixed(2)}, </tspan><tspan x="0" y="12">earnings</tspan></text></g>)
            ...
            const label = (showlabel) => {
                if (showlabel) {
                    return (<g> <path className="largeexpanded-6" d="M691.84,330.05V356a1.91,1.91,0,0,1-1.91,1.91H622.46a1.88,1.88,0,0,0-.52.08l-12.36,3.47a1.91,1.91,0,0,1-2.35-2.36l3-10.72a2.25,2.25,0,0,0,.07-.52V330.05a1.91,1.91,0,0,1,1.91-1.91h77.71A1.92,1.92,0,0,1,691.84,330.05Z" />
                        <text className="largeexpanded-7" transform="translate(613.52 340.06)"><tspan>{abbMonth(shift.timein)}, ${Number(shift.earnings).toFixed(2)}, </tspan><tspan x="0" y="12">earnings</tspan></text></g>)
            ...
            const label = (showlabel) => {
                if (showlabel) {
                    return (<g><path className="largeexpanded-6" d="M991.55,330.05V356a1.91,1.91,0,0,1-1.91,1.91H922.17a1.88,1.88,0,0,0-.52.08l-12.36,3.47a1.91,1.91,0,0,1-2.35-2.36l3-10.72a2.25,2.25,0,0,0,.07-.52V330.05a1.91,1.91,0,0,1,1.91-1.91h77.71A1.92,1.92,0,0,1,991.55,330.05Z" />
                        <text className="largeexpanded-7" transform="translate(913.23 340.06)"><tspan>{abbMonth(shift.timein)}, ${Number(shift.earnings).toFixed(2)}, </tspan><tspan x="0" y="12">earnings</tspan></text></g>)
